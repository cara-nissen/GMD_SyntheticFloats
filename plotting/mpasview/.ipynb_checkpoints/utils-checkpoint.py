...
def get_index_lonlat(
    ...
    # scale the distance in the zonal direction by the latitude, centered on the target location
...
def get_info_region(name):
    ...
    info = {
            'Global': (  0., 360., -90., 90.),
            'SouthernOcean': (  0., 360., -90., -40.),
            'SO_highLats': (  0., 360., -90., -55.), # added by CN
            'SO_highLats40': (  0., 360., -90., -40.), # added by CN
            'SO_highLats45': (  0., 360., -90., -45.), # added by CN
            'SouthernOcean_v2': (  0., 360., -90., -40.), # added by CN
            'DrakePassage': (  270., 310., -75., -50.), # added by CN
            'LabSea': (270., 356.,  36., 75.),
            'NorthPacific':  (130., 195., 20., 60.),
            'TropicalPacific':  (130., 290., -25., 25.),
            'TropicalPacificSmall':  (160., 280., -10., 10.),
            'TropicalAtlantic': (310., 380., -20., 20.),
            'east_pacific': (220., 310., -50., 10.), # to cut data, be more generous here to now have white areas
            'south_atlantic': (280., 360., -50., 10.), # to cut data, be more generous here to now have white areas
            'north_pacific': (100., 320., -10., 45.), # to cut data, be more generous here to now have white areas
            }
